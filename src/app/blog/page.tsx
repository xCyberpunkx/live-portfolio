...
export const metadata: Metadata = {
  ...
  description: "Short insights on software engineering, network architecture, and modern web development.",
};
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {posts.map((post, index) => (
            <article 
              key={index} 
              className="group flex flex-col bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/[0.08] transition-all duration-500"
            >
              ...
              <h2 className="text-2xl font-bold uppercase tracking-tight mb-4 group-hover:text-white transition-colors">
              ...
              <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                ...
                <Link href={`/blog/${post.slug}`} className="text-white group-hover:translate-x-1 transition-transform">
                  <ArrowRight size={20} />
                </Link>
              </div>
            </article>
