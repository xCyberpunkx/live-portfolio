      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert prose-lg max-w-4xl">
          <section className="mb-12">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-white mb-6">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-white mb-6">2. Use License</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-white mb-6">3. Disclaimer</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-white mb-6">4. Limitations</h2>
            <p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-white mb-6">5. Revisions and Errata</h2>
            <p>
