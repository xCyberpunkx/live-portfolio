      ...
      <div className="container relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl flex flex-col items-center justify-center">
          <div className="absolute left-0 top-1/2 -translate-y-1/2 -rotate-90 origin-left hidden lg:block">
            <span className="text-[10px] uppercase tracking-[0.3em] font-technical text-[#4A4D43]">Research</span>
          </div>
          ...
          <div className="relative w-full aspect-[4/3] max-h-[500px] flex items-center justify-center">
             <div className="text-center">
                <h2 className="text-[15vw] font-black text-[#D9FF00] leading-none tracking-tighter opacity-10">ZR</h2>
                <div className="text-off-white font-technical text-sm tracking-widest mt-4">SECURE SYSTEMS ARCHIVE</div>
             </div>
          </div>

          <div className="mt-8 mb-24 z-20">
            <a 
              href="mailto:zineddine@example.com"
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center justify-items-center opacity-60 mb-12">
          {['GitHub', 'LinkedIn', 'Twitter', 'Vercel', 'Linux', 'Rust'].map((brand, idx) => (
        ...
        <div className="mx-4 mb-4">
          <div className="bg-[#D9FF00] h-[60px] rounded-2xl flex items-center justify-between px-6 md:px-10 overflow-hidden">
            <div className="text-black text-[11px] font-technical tracking-wider">
              © 2025 Zinedine Rouabah. Systems & Security Research
            </div>
            <div className="flex gap-6 md:gap-10">
              <a href="#" className="text-black text-[11px] font-technical font-bold uppercase tracking-wider hover:opacity-70 transition-opacity">Privacy</a>
              <a href="#" className="text-black text-[11px] font-technical font-bold uppercase tracking-wider hover:opacity-70 transition-opacity">Legal</a>
            </div>
          </div>
        </div>
