        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          <div className="lg:col-span-4 mb-16 lg:mb-0">
            <div className="lg:sticky lg:top-32">
              ...
              <h2 className="text-[16vw] lg:text-[6vw] font-black text-white uppercase leading-[0.85] tracking-tighter mb-12">
                THE<br />
                ...
                >
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="flex flex-wrap items-center gap-6">
                      <span className="text-[10px] font-technical text-white/20 group-hover:text-white/60 transition-colors duration-500">
                        [{exp.id}]
                      </span>
                      ...
                      <span className="px-2 py-0.5 border border-white/10 text-[7px] font-technical text-white/20 rounded uppercase">
                        {exp.status}
                      </span>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-xl md:text-2xl font-black text-white/10 uppercase tracking-tight group-hover:text-white/40 transition-colors duration-700">
                        // {exp.company}
                      </p>
                    </div>

                    <div className="relative">
                      <div className="absolute -left-4 top-0 bottom-0 w-[1px] bg-white/5 scale-y-0 group-hover:scale-y-100 transition-transform duration-700 origin-top" />
